...
class JeeMain extends StatefulWidget {
  ...
  JeeMain(this.documentId);

  @override
  State<JeeMain> createState() => _FormAppState();
}

class _FormAppState extends State<JeeMain> {
  @override
  ...
  Future addformData(String email1) async {
    ...
    final userDocRef =
        FirebaseFirestore.instance.collection('Jee Main').doc(user?.uid);
