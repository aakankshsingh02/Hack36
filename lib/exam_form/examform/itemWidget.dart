...
import 'package:hack36/exam_form/examform/form12.dart';
import 'package:hack36/exam_form/examform/formJadv.dart';
import 'package:hack36/exam_form/examform/formJmains.dart';
import 'package:hack36/exam_form/examform/formNeet.dart';
                  ...
                  onPressed: () {
                    if (widget.item.name == "JEE MAIN") {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => FormApp(userId!)));
                    }
                  },
