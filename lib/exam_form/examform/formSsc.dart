...
class sscCGL extends StatefulWidget {
  final String documentId;

  sscCGL(this.documentId);

  @override
  State<sscCGL> createState() => _FormAppState();
}

class _FormAppState extends State<sscCGL> {
  @override
  ...
  Future addformData(String email1) async {
    ...
    final userDocRef =
        FirebaseFirestore.instance.collection('SSC CGL').doc(user?.uid);
