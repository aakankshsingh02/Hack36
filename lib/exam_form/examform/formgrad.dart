...
import 'package:hack36/screens/payment.dart';

class FormGrad extends StatefulWidget {
  final String documentId;

  FormGrad(this.documentId);

  @override
  State<FormGrad> createState() => _FormAppState();
}

class _FormAppState extends State<FormGrad> {
  @override
  ...
  Future addformData(String email1) async {
    ...
    final userDocRef =
        FirebaseFirestore.instance.collection('Grad').doc(user?.uid);
